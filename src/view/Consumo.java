...
public class Consumo extends JFrame {
	...
	public Consumo() {
		...
		cmbQuarto.setBounds(298, 141, 128, 22);
		...
		btnProcurar.setBounds(451, 139, 116, 25);
		...
		scrollPane.setBounds(301, 196, 588, 246);
		...
		//Botao de Logout
				...
				lblConsumo.setFont(new Font("Verdana", Font.BOLD, 23));
				lblConsumo.setBounds(522, 53, 133, 38);
